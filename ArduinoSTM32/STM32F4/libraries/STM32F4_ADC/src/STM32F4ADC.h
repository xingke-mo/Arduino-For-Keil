...
public:
    ...
    */
    ...
    {
        return analogReadDev(pin, _dev);
    }

    uint32 getData()
    {
        return adc_get_data(_dev);
    }

    void enableTsVref(void)
    {
        adc_enable_tsvref();
    }
    ...
    */
    ...
    uint8_t getDMAHalfFlag()
    {
        return dma_get_isr_bit(DMA2, _dev->dmaStream, DMA_ISR_HTIF);
    }
    uint8_t getDMACompleteFlag()
    {
        return dma_get_isr_bit(DMA2, _dev->dmaStream, DMA_ISR_TCIF);
    }

    void clearDMAIsrBits()
    {
