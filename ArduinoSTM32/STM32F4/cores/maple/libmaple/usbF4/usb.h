...
inline uint32_t usbBytesAvailable(void)
{
...
inline uint8_t usbGetDTR(void)
{
    return VCPGetDTR();
};
inline uint8_t usbGetRTS(void)
{
    return VCPGetRTS();
};
...
inline uint8_t usbIsConnected(void)
{
    return usb_isConnected();
}
inline uint8_t usbIsConfigured(void)
{
...
inline void usbEnableBlockingTx(void)
{
    VCP_SetUSBTxBlocking(1);
}
inline void usbDisableBlockingTx(void)
{
