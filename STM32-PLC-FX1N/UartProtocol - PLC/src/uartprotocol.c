...
static u8 WriteByte(u8 dat)
{
    ...
    sendSize--;
    sendSum += sendbuff[sendPos++] = dat;

    if(sendPos == SEND_BUFF_LEN)
    {
        sendPos = 0;
    }
...
static u8 WriteWord(u16 dat)
{
    ...
    sendSize -= 2;
    sendCount += 2;
    sendSum += sendbuff[sendPos++] = _16T8H(dat);
    ...
    sendSum += sendbuff[sendPos++] = _16T8L(dat);
...
static u8 WriteDWord(u32 dat)
{
    ...
    sendSize -= 4;
    sendCount += 4;
    sendSum += sendbuff[sendPos++] = _32T8HH(dat);
    ...
    sendSum += sendbuff[sendPos++] = _32T8H(dat);
    ...
    sendSum += sendbuff[sendPos++] = _32T8L(dat);
    ...
    sendSum += sendbuff[sendPos++] = _32T8LL(dat);
